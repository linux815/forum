...
class bb_size extends bbcode {
    ...
    function get_html() {
        ...
        $size = $sign.$size;
        return '<font style="font-size:'.$size.'pt">'.parent::get_html($this -> tree).'</font>';
		}
}
